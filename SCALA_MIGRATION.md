...
corrects what row 8 said about the cached paths. **Impact** is measured rather than assumed
...
tree as it stands, and rows 13 to 16 from the CI definition itself:
...
git show 7e11df417:.circleci/config.yml |
  diff -u - .circleci/config.yml | grep -c '^-[^-]'           # row 13: 0 removed lines
